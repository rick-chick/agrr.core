...
def test_get_available_models_success(interactor, mock_gateways):
    ...
    # Execute
    result = interactor.get_available_models()
...
def test_get_available_models_empty(interactor, mock_gateways):
...
def test_get_available_models_error(interactor, mock_gateways):
    ...
    with pytest.raises(PredictionError, match="Failed to get available models"):
        interactor.get_available_models()

def test_get_model_info_success(interactor, mock_gateways):
    ...
    # Execute
    result = interactor.get_model_info('Prophet')
...
def test_get_model_info_error(interactor, mock_gateways):
    ...
    with pytest.raises(PredictionError, match="Failed to get model info for Prophet"):
        interactor.get_model_info('Prophet')

def test_compare_models_not_implemented(interactor):
...
def test_compare_models_with_parameters(interactor, mock_gateways):
