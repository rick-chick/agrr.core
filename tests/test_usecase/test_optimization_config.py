...
class TestOptimizationConfig:
    ...
    def test_default_config(self):
        ...
        assert config.quantity_levels == [1.0, 0.75, 0.5, 0.25]
    ...
    def test_fast_profile(self):
        ...
        assert config.quantity_levels == [1.0, 0.5]
    ...
    def test_quality_profile(self):
        ...
        assert len(config.quantity_levels) == 9
