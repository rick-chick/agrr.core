"""LightGBM-based weather prediction service implementation.

DEPRECATED: This file is kept for backward compatibility only.
New code should use:
  - src/agrr_core/framework/services/lightgbm_prediction_service.py (Framework layer)
...
class PredictionLightGBMService(PredictionModelGateway):
    """LightGBM-based implementation of weather prediction service."""
